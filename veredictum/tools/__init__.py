...
from .attachment_tools import analyze_attachment, vt_lookup
...
try:
    ...
    HERRAMIENTAS = [parse_email, extract_iocs, analyze_attachment, vt_lookup, write_report]
except ImportError:
    write_report = None
    HERRAMIENTAS = [parse_email, extract_iocs, analyze_attachment, vt_lookup]
